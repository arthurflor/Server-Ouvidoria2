...
<link rel="icon" href="<?php echo $pasta_raiz_site; ?>imagens/logo.ico" type="image/x-icon" />
<link rel="shortcut icon" href="<?php echo $pasta_raiz_site; ?>imagens/logo.ico" type="image/x-icon" />
